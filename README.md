...
```kotlin
v5.0.0
1. Groovy DSL 改为 Kotlin DSL, 并更新 gradle dependencies
2. 多选模式下错误提醒具体到是哪几种类型文件选择出了问题(FileSelector.obtainResult)
3. FileType.HTML 并入 FileType.TXT
...
implementation 'com.github.javakam:file.core:5.0.0@aar'      //核心库必选(Core library required)
implementation 'com.github.javakam:file.selector:5.0.0@aar'  //文件选择器(File selector)
implementation 'com.github.javakam:file.compressor:5.0.0@aar'//图片压缩,修改自Luban(Image compression, based on Luban)
```

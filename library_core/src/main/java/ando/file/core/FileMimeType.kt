...
object FileMimeType {
    ...
    fun getMimeType(path: String?): String {
        ...
        if (path.isNullOrBlank()) return type
        val extension = MimeTypeMap.getFileExtensionFromUrl(path)
        val mimeType = getMimeTypeSupplement(path) ?: (MimeTypeMap.getSingleton().getMimeTypeFromExtension(extension) ?: type)
     ...
     */
    fun getMimeTypeSupplement(extension: String): String? = mimeTables[extension]

    //From  https://github.com/zhanghai/MaterialFiles/
    private val mimeTables = mapOf(
